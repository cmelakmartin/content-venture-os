...
META_PAGE_ID=...
META_PIXEL_ID=...
META_DSA_BENEFICIARY="Legal name of person or organisation being promoted"
META_DSA_PAYOR="Legal name of person or organisation paying for the ads"
META_API_VERSION=v25.0
```

The two DSA transparency names are required when an ad targets the EU/EEA. They may be the same legal name when the promoted business also pays for its own advertising; enter the truthful real-world names rather than an internal campaign label.
