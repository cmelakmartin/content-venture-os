...
function refreshConnections() {
  ...
  state.connections.stripe = { status: process.env.STRIPE_WEBHOOK_SECRET ? "webhook_ready" : "test_links_ready", mode: process.env.STRIPE_WEBHOOK_SECRET ? "test_events" : "test_links_only" };
